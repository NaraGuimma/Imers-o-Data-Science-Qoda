...
class Ground():
    def __init__(self,speed=-5):
        ...
        self.rect1.botom = height
        self.rect1.left = self.rect.ptera_height
        self.speed = speed
    ...
    def update(self):
        ...
        self.rect1.left += self.jumpSpeed
        ...
        if pygame.display.get_Surface() == None:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE or event.key == pygame.K_UP:
                    temp_dino_isJumping = True
                    temp_dino_isBlinking = False
...
def gameplay():
    ...
    HI_image = pygame.Suface((22,int(11*6/5)))
    HI_rect = HI_image.get_rect()
    HI_image.fill(background_col)
    HI_image.blit(temp_images[10], temp_rect)
    temp_rect.left += temp_rect.width
    HI_image.blit(tempimages[11],temp_rect)
    ...
    while not gameQuit:
        ...
        while gameOver:
            if pygame.display.get_surface() == None:
                peint('Could not load display surface')
                gameQuit = True
                gameOver = False
